...
All posts are grouped within the “data/docs” folder.

They are organized into subfolders: "data/docs/en" for English, and "data/docs/fr" for French.
...
En: "data/docs/en/code-sample.mdx"
Fr: "data/docs/fr/code-sample.mdx"
